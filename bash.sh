...
#         echo "GPU based"
#         echo "Hyper"
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset query --data npz --graph_type Hypergraph  --beta 0.5 --knn_k 10
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset cora --data coauthorship --graph_type Hypergraph   --beta 0.5 --knn_k 10
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset cora --data cocitation --graph_type Hypergraph   --beta 0.5 --knn_k 10
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset citeseer --data cocitation --graph_type Hypergraph   --beta 0.5 --knn_k 10
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset 20news --data npz --graph_type Hypergraph   --beta 0.5 --knn_k 10
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset dblp --data coauthorship --graph_type Hypergraph   --beta 0.5 --knn_k 10

#         echo "Undirected"
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset cora --graph_type Undirected  --beta 0.4 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset citeseer --graph_type Undirected  --beta 0.4 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset pubmed --graph_type Undirected  --beta 0.06 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset wiki --graph_type Undirected  --beta 0.5 --knn_k 50

#         echo "Directed"
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset citeseer --graph_type Directed  --beta 0.4 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset cora_ml --graph_type Directed  --beta 0.5 --knn_k 50

#         echo "Multi"
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset acm --graph_type Multi  --beta 0.7 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset imdb --graph_type Multi  --beta 0.4 --knn_k 50
#         sudo cset proc -s $set -e $PYTHON -- gANCKA.py --dataset dblp --graph_type Multi  --beta 0.1 --knn_k 50
