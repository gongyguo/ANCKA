{
    ...
    python ANCKA.py --dataset amazon --data npz --network_type HG --scale --beta 0.4 --knn_k 10 --interval 1
    python ANCKA.py --dataset magpm --data npz --network_type HG  --scale --beta 0.4 --knn_k 10 
...

{
    ...
    python ANCKA.py --dataset amazon --data npz --network_type HG --scale --beta 0.4 --knn_k 10 --gpu --times 1 --interval 1
